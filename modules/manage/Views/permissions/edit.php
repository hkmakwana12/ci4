        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= route_to('admin.permissions') ?>">Permissions</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="permission_name" class="form-control <?= ($validation->getError('permission_name')) ? 'is-invalid' : ''; ?>" value="<?= set_value('permission_name', $permission->permission_name) ?>" id="permission_name">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->getError('permission_display_name')) ? 'is-invalid' : ''; ?>" name="permission_display_name" value="<?= set_value('permission_display_name', $permission->permission_display_name) ?>" id="permission_display_name">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="permission_description" id="permission_description" class="form-control <?= ($validation->getError('permission_description')) ? 'is-invalid' : ''; ?>"><?= set_value('permission_description', $permission->permission_description) ?></textarea>
