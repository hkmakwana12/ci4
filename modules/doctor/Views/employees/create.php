        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="<?= route_to('admin.employees.create') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="employee_full_name" class="form-control <?= ($validation->getError('employee_full_name')) ? 'is-invalid' : ''; ?>" value="<?= set_value('employee_full_name'); ?>" id="employee_full_name" tabindex="1">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="employee_address" class="form-control <?= ($validation->getError('employee_address')) ? 'is-invalid' : ''; ?>" value="<?= set_value('employee_address'); ?>" id="employee_address" tabindex="2">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->getError('employee_aadhar_number')) ? 'is-invalid' : ''; ?>" name="employee_aadhar_number" value="<?= set_value('employee_aadhar_number'); ?>" id="employee_aadhar_number" tabindex="3">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="email" class="form-control <?= ($validation->getError('employee_email')) ? 'is-invalid' : ''; ?>" name="employee_email" value="<?= set_value('employee_email'); ?>" id="employee_email" tabindex="4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="employee_phone" class="form-control <?= ($validation->getError('employee_phone')) ? 'is-invalid' : ''; ?>" value="<?= set_value('employee_phone'); ?>" id="employee_phone" tabindex="5">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="date" name="employee_date_of_birth" class="form-control <?= ($validation->getError('employee_date_of_birth')) ? 'is-invalid' : ''; ?>" value="<?= set_value('employee_date_of_birth'); ?>" id="employee_date_of_birth" tabindex="8">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="employee_religion" class="form-control <?= ($validation->getError('employee_religion')) ? 'is-invalid' : ''; ?>" value="<?= set_value('employee_religion'); ?>" id="employee_religion" tabindex="9">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="employee_education" class="form-control <?= ($validation->getError('employee_education')) ? 'is-invalid' : ''; ?>" value="<?= set_value('employee_education'); ?>" id="employee_education" tabindex="10">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="employee_occupation" class="form-control <?= ($validation->getError('employee_occupation')) ? 'is-invalid' : ''; ?>" value="<?= set_value('employee_occupation'); ?>" id="employee_occupation" tabindex="11">
