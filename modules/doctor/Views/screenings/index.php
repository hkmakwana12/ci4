...
<form role="form" id="deleteForm" action="<?= route_to('admin.stores.delete', 0); ?>" method="post">
    <?= csrf_field(); ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tool">
                            <a class="btn btn-primary btn-sm float-right" href="<?= route_to('admin.stores.create'); ?>"><span class="fas fa-plus">&nbsp;</span>Add</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                        ...
                                        <?php foreach ($stores as $store) : ?>
                                            <tr>
                                                <td class="text-center">
                                                    <div class="icheck-primary d-inline">
                                                        <input type="checkbox" class="sub_checkbox" id="sub_checkbox<?= $store->id ?>" data-id="<?= $store->id ?>">
                                                        <label for="sub_checkbox<?= $store->id ?>">
                                                        </label>
                                                    </div>
                                                </td>
                                                ...
                                                <td><?= $store->store_name ?></td>
                                                <td width="150px">
                                                    <a href="<?= route_to('admin.stores.edit', $store->id) ?>" class="btn btn-sm btn-primary">Edit</a>
                                                    <button type="button" class="btn btn-sm btn-danger deleteItem" data-toggle="modal" data-target="#modal-delete" data-id="<?= $store->id ?>">Delete</button>
                                                </td>
                                            </tr>
                                        <?php endforeach;
                                    else : ?>
                    ...
                    <div class="card-footer clearfix">
                        <?php
                        if ($pagination_link) {
                            $pagination_link->setPath('admin/stores');
