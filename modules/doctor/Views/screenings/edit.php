                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="store_name" class="form-control <?= ($validation->getError('store_name')) ? 'is-invalid' : ''; ?>" value="<?= set_value('store_name', $store->store_name) ?>" id="store_name">
