                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="category_name" class="form-control <?= ($validation->getError('category_name')) ? 'is-invalid' : ''; ?>" value="<?= set_value('category_name', $category->category_name) ?>" id="category_name">
