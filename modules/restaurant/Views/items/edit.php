                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="item_name" class="form-control <?= ($validation->getError('item_name')) ? 'is-invalid' : ''; ?>" value="<?= set_value('item_name', $item->item_name) ?>" id="item_name" placeholder="Enter Item Name">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="item_price" class="form-control <?= ($validation->getError('item_price')) ? 'is-invalid' : ''; ?>" value="<?= set_value('item_price', $item->item_price ?? 0) ?>" id="item_price" placeholder="Enter Price">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="item_description" id="item_description" class="form-control <?= ($validation->getError('item_description')) ? 'is-invalid' : ''; ?>" placeholder="Enter Item Description"><?= set_value('item_description', $item->item_description) ?></textarea>
