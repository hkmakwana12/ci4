        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Add Employers</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="<?= route_to('admin.employers.create') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="organization_type" name="organization_type" class="form-control <?= ($validation->getError('organization_type')) ? 'is-invalid' : ''; ?>" tabindex="7">
                                        <option value="Govt" <?= set_select('organization_type', 'Govt'); ?>>Govt</option>
                                        <option value="Pvt" <?= set_select('organization_type', 'Pvt'); ?>>Pvt</option>
                                    </select>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="organization_name" class="form-control <?= ($validation->getError('organization_name')) ? 'is-invalid' : ''; ?>" value="<?= set_value('organization_name'); ?>" id="organization_name" tabindex="8">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="address_line_1" class="form-control <?= ($validation->getError('address_line_1')) ? 'is-invalid' : ''; ?>" value="<?= set_value('address_line_1'); ?>" id="address_line_1" tabindex="9">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="address_line_2" class="form-control <?= ($validation->getError('address_line_2')) ? 'is-invalid' : ''; ?>" value="<?= set_value('address_line_2'); ?>" id="address_line_2" tabindex="10">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="landmark" class="form-control <?= ($validation->getError('landmark')) ? 'is-invalid' : ''; ?>" value="<?= set_value('landmark'); ?>" id="landmark" tabindex="11">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="pan_number" class="form-control <?= ($validation->getError('pan_number')) ? 'is-invalid' : ''; ?>" value="<?= set_value('pan_number'); ?>" id="pan_number" tabindex="12">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="gst_number" class="form-control <?= ($validation->getError('gst_number')) ? 'is-invalid' : ''; ?>" value="<?= set_value('gst_number'); ?>" id="gst_number" tabindex="13">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="designation" class="form-control <?= ($validation->getError('designation')) ? 'is-invalid' : ''; ?>" value="<?= set_value('designation'); ?>" id="designation" tabindex="14">
